...
BOT_TOKEN = getenv("BOT_TOKEN", "5433958614:AAE9o1X05FoK4Ux0rCnJDipf1Ild914EVgc")
BOT_NAME = getenv("BOT_NAME", "M𝘶𝘴𝘪𝘤 🍷𖠛")
...
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "DZZD7")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "DZZD7")
